...
size and latency options. The first number can be 'one.0', '0.75', '0.50', or
...
def get_random_distorted_bottlenecks(
  ...
  for unused_i in range(how_many):
    ...
    # sending running inference on the image. This involves two memory copies and
...
def create_model_info(architecture):
  ...
  if architecture == 'inception_v3':
    ...
    if (version_string != 'one.0' and version_string != '0.75' and
        version_string != '0.50' and version_string != '0.25'):
      tf.logging.error(
          """"The Mobilenet version should be 'one.0', '0.75', '0.50', or '0.25',
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      ...
      A value of -one causes the entire test set to be used, which leads to more
  ...
  parser.add_argument(
      ...
      A value of -one causes the entire validation set to be used, which leads to
